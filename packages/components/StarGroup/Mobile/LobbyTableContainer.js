"use strict";
Vue.component("LobbyTableContainer", 
{
    template: '\n    '+
	...
	'<ui-prop v-prop="target.countDown"></ui-prop>\n    '+
	'<ui-prop v-prop="target.dealerName"></ui-prop>\n    '+
	'<ui-prop v-prop="target.tableInfo"></ui-prop>\n    '+
	
	'<ui-prop v-prop="target.dealerPhoto"></ui-prop>\n    '+
	'<ui-prop v-prop="target.content"></ui-prop>\n    '+
	'<ui-prop v-prop="target.maskLayer"></ui-prop>\n    '+
