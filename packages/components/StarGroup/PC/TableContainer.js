...
Vue.component("TableContainer", 
{
    ...
    '</div>\n    '+
	'<cc-array-prop :target.sync="target.textColors"></cc-array-prop>\n    '+
	'<cc-array-prop :target.sync="target.tableIcons"></cc-array-prop>\n    '+
	'<ui-prop v-prop="target.tableIcon"></ui-prop>\n    '+
	'<ui-prop v-prop="target.tableName"></ui-prop>\n    '+
	'<ui-prop v-prop="target.totalBet"></ui-prop>\n    '+
	'<ui-prop v-prop="target.dealerImage"></ui-prop>\n    '+
	'<ui-prop v-prop="target.dealerName"></ui-prop>\n    '+
	'<ui-prop v-prop="target.online"></ui-prop>\n    '+
	'<ui-prop v-prop="target.StatisticsBtn"></ui-prop>\n    '+
	'<ui-prop v-prop="target.content"></ui-prop>\n    '+
	'<ui-prop v-prop="target.maintainNode"></ui-prop>\n    '+
	'<ui-prop v-prop="target.countdownLab"></ui-prop>\n    '+
	'<ui-prop v-prop="target.statusTip"></ui-prop>\n    '+
	'<ui-prop v-prop="target.tip"></ui-prop>\n    '+
	'<ui-prop v-prop="target.simpleMode"></ui-prop>\n    '+
